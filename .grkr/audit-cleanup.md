...
| Path | Size | lsof | Action |
|------|------|------|--------|
| `~/.hermes/kanban.db.dispatch.lock` | 0B | none | **REMOVED** (reappeared empty/unheld; pre-delete comment added to t_89935a31) |
...
**Metadata:** `{locks_removed: ["~/.hermes/kanban.db.dispatch.lock"], locks_kept: ["~/.hermes/gateway.lock","~/.hermes/kanban/.dispatcher.lock","~/.hermes/cron/.tick.lock","~/.hermes/cron/.jobs.lock"], worktrees_pruned: 0, head_pre: "cbda523"}`
