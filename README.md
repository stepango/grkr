...
- `grkr --issue <id>` normalizes generated PR bodies so only one issue reference remains: `Fixes #<id>`, removing duplicate `Issue:` lines that reference the same issue id or issue URL.
