...
- Bin updates/hygiene (per AGENTS: preserve sh conv, small explicit changes, <1000 LOC): **doctor.sh (51 LOC thin: doctor_init + delegate to `grkr/doctor/cli`)**, grkr-project-status.sh (81 LOC thin), grkr-issue-workflow.sh (80 LOC thin wrapper delegating workflow/* CLIs incl decision_gate + test_completion_marker), worker-handle-comment.sh (29 LOC thin), worker-pick-issue.sh (46 LOC), worker-sync-main.sh (18 LOC), worker-resolve-pr.sh (39 LOC), worker-refuse-issue.sh (40 LOC thin calling refusal/cli), robot-main.sh (57 LOC), grkr (now thinner post-extract), grkr-templates.sh (62 LOC thin), + bin/lib/{refusal_paths.sh,task_progress.sh,github_issue.sh,linear_issue_stages.sh} (github_issue.sh holds GitHub verticals; linear_issue.sh sources linear_mutate + now linear_issue_stages (first extract test checkpoint @PR#125: 923→770; second extract publish+complete @PR#127 / **8ae5250**: 770→613 LOC, stages 186→357; third extract refusal @PR#129 / **ce34b29**: 613→495 / stages 357→483; fourth extract research/plan + implement_in_progress @PR#131 / **48aa21b**: 495→386 / 483→599; fifth/final thin sequencer @PR#133 / **f6b34d4**: 386→329 / 599→725; call sites unchanged); shared write_test_checkpoint_with_header + ensure_publishable_file_sizes stay in grkr for Linear reuse). grkr now ~435 LOC (thinner post process_issue thin orchestrator t_3619188b).
