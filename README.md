...
- Remaining work (Linear guarded live mutate **landed** @ **e28d0c0** / PR #104; nits **8d4b674** / PR #107; optional `GRKR_LINEAR_MUTATE_STRICT=1` **82f3644** / PR #110; GitHub process_issue thinning tip **53592d4** / PR #117 — research/plan checkpoint extract after publish helpers **6e0f1d3** / #115 + test checkpoint **c438409** / #112, `bin/grkr` 639→545; `GRKR_LINEAR_MUTATE=1` enables apply, default OFF / dry-run; further `bin/grkr` thinning still open (completion surface, thin process_issue); refuse dry-run t_503ca0f3 + t_e47417cb / PR #95 @ **8aba009** lineage; supervisor Linear pick→schedule→spawn already landed; GitHub default; spec/39 items 6–12 implemented; see gleam-migration.md table)
