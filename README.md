...
- workflow/ (decision 270, decision_gate 155 (spec/22), implement_stage 36 + test, test_stage 66 LOC (run-tests + completion-marker per spec/26+39), handle_comment 92 (thin facade) + handle_comment_* (types 23, context 129, reactions 48, worktree 88, codex 87, result 40) LOC hygiene split landed @ **e358311** / PR #158 (t_a12fcdec), resolve_pr/main 426 full + skeleton, task_log split, worktree split, main/ffi); note supervisor/comment_handler split is parallel hygiene (not workflow/)
