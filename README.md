...
- Remaining work (Linear guarded live mutate **landed** @ **e28d0c0** / PR #104; nits **8d4b674** / PR #107; optional `GRKR_LINEAR_MUTATE_STRICT=1` **82f3644** / PR #110; GitHub process_issue thinning complete (product tip **a3d9702** / PR #121 after **def63d8** / #119: thin orchestrator; `bin/grkr` 527→435); Linear thinning design tip **ad3e9a4** / PR #123 + docs tip-sync #124 @ **729abd0**; Linear first extract product tip **7721b61** / PR #125 (t_9c0c6ab9: `ensure_linear_test_checkpoint` → `bin/lib/linear_issue_stages.sh`, `linear_issue.sh` 923→770); second Linear extract slice (publish+complete to stages; linear_issue.sh 770→613); next refusal/etc.; `GRKR_LINEAR_MUTATE=1` enables apply, default OFF / dry-run; refuse dry-run t_503ca0f3 + t_e47417cb / PR #95 @ **8aba009** lineage; supervisor Linear pick→schedule→spawn already landed; GitHub default; spec/39 items 6–12 implemented; see gleam-migration.md table)
