...
# Stages-split slice 2 (this): test cluster extracted to
# github_issue_stages_test.sh (write_test_checkpoint_file + ensure_test_checkpoint).
# This file sources siblings fail-closed in order: research_plan then test.
# Remaining stage bodies until later slices:
