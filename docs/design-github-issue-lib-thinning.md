...
| Checkpoint comment json helpers (optional; low-ROI) | small focused (or leave); `github_issue.sh` | `checkpoint_marker` (shared) | Resume/restore for research/plan/test unchanged; GitHub regressions green | small or 0 |
