...
**Current implementation status (2026-07-17, product tip @ **d04f5e9** / PR #136 (shared first slice test-write: grkr 435→339 / issue_shared 110); slice 2 line-limit+ensure_publishable (t_9e60aed0: grkr 339→279 / issue_shared 110→178) landed; lineage design **d90fbaf** / PR #135; GitHub default; `gleam build` clean. (See full table + remaining below.)**
