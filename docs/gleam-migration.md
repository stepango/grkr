...
- **PR #79 MERGED** to `main` @ 78f4fb8 (2026-07-10); Linear JobKey @ **ce61881**; MVP tip **28e4794** (PR #93); refuse tip **8aba009** (PR #95); implement tip **d1c1240** (PR #97); test tip **bfee58c** (PR #98); publish tip **bd523a6** (PR #100); live-mutate land **e28d0c0** (PR #104); Linear variables FFI **36f8f03** (PR #106); live-mutate nits **8d4b674** (PR #107); optional STRICT **82f3644** (PR #110); docs tip-sync #111 @ **f07d578**; test-checkpoint thinning **c438409** (PR #112); docs tip-sync #113 @ **219fde5**; publish-helpers thinning **6e0f1d3** (PR #115); docs tip-sync #116 @ **2ac57fb**; research/plan thinning **53592d4** (PR #117); docs tip-sync #118 @ **bf530e5**; completion surface thinning **def63d8** (PR #119; grkr 545→527); docs tip-sync #120 @ **321aa11**; process_issue thin orchestrator product tip **a3d9702** (PR #121 / t_3619188b; `bin/grkr` 527→435; github_issue.sh 387→539); docs tip-sync #122 @ **bdf396b**; Linear thinning design tip **ad3e9a4** (PR #123 / t_8f47892b); docs tip-sync #124 @ **729abd0** after #123; Linear first extract product tip **7721b61** (PR #125 / t_9c0c6ab9; `linear_issue.sh` 923→770; stages 186); docs tip-sync #126 @ **57eef93** after #125; Linear second extract product tip **8ae5250** (PR #127 / t_8ca53b63; `linear_issue.sh` 770→613; stages 357); docs tip-sync #128 @ **1ac9be2** after #127; Linear third extract product tip **ce34b29** (PR #129 / t_7d3260b2; `linear_issue.sh` 613→495; stages 483); docs tip-sync #130 @ **b97fecc** after #129; Linear fourth extract product tip **48aa21b** (PR #131 / t_81b53e16; `linear_issue.sh` 495→386; stages 599); ongoing e2e cron regression + kanban hygiene (process — not missing spec/39 core modules)
- **Next product thinning:** GitHub `process_issue` thinning **complete** (design [`docs/design-github-process-issue-thinning.md`](design-github-process-issue-thinning.md); slices PR #112/#115/#117/#119/#121 → product tip **a3d9702**; `bin/grkr` 435 thin launcher; `github_issue.sh` 539). **Linear thinning first slice landed** @ **7721b61** / PR #125 (t_9c0c6ab9): extract `ensure_linear_test_checkpoint` (~159 LOC) to sibling `bin/lib/linear_issue_stages.sh` per design tip **ad3e9a4** / PR #123 [`docs/design-linear-issue-thinning.md`](design-linear-issue-thinning.md) §9. `linear_issue.sh` sources stages after `linear_mutate.sh`; call site unchanged; net thinner (923→770 LOC); stages 186 LOC. **Second Linear slice landed** @ **8ae5250** / PR #127 (t_8ca53b63): extract `ensure_linear_publish_complete` (~151 LOC) to same sibling `bin/lib/linear_issue_stages.sh` (append after test fn); exact body+comment move, no wrapper, source order mutate-then-stages, call site identical. linear_issue.sh: 770→613 LOC (net thinner); stages 186→357 LOC; both <<1000. GitHub untouched. **Third Linear slice landed** @ **ce34b29** / PR #129 (t_7d3260b2): extract `ensure_linear_refusal_checkpoint` (~117 LOC) from linear_issue.sh into existing sibling `bin/lib/linear_issue_stages.sh` (append after publish+complete); exact body+preceding comment block, no wrapper left behind; source comment updated for Slice 3; ambient (run_progress_cli plan-linear-refusal/render/linear-*-mutation/linear-state, mark_task_progress_refused, maybe_apply from linear_mutate) listed in header. linear_issue.sh: 613→495 LOC (net thinner); stages 357→483 LOC; both ≤1000. GitHub untouched. **Fourth Linear slice landed** @ **48aa21b** / PR #131 (t_81b53e16): extract `ensure_linear_checkpoint_stage` (research/plan) + `ensure_linear_implement_in_progress` from linear_issue.sh into `bin/lib/linear_issue_stages.sh` (append after refusal); exact body+comments, no wrappers; headers updated for Slice 4 ambients. linear_issue.sh: 495→386 LOC; stages 483→599 LOC; both ≤1000. GitHub untouched (empty diff). Per AGENTS: README + this file updated (lineage ce34b29/#129 + docs tip-sync #130 @ b97fecc after #125/#127; landed #131 @ **48aa21b**). **Next:** thin process_linear_issue sequencer. Prior lineage retained.
