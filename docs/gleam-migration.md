...
**Current implementation status (2026-07-17, product tip @ **593e18b** / PR #138 (shared second slice line-limit+ensure_publishable: grkr 339→279 / issue_shared 110→178; t_9e60aed0); lineage first extract **d04f5e9** / PR #136 + docs tip-sync #137 @ **5e53aaf** + design **d90fbaf** / PR #135; GitHub default; `gleam build` clean. (See full table + remaining below.)**
