...
**Current implementation status (2026-07-18, product tip @ **f6fb872** / PR #142 (shared fourth slice run_progress_cli + checkpoint_marker → issue_shared: grkr 260→233 / issue_shared 198→228; t_bc6ebfda); lineage third extract **325ee9a** / PR #140 + docs tip-sync #141 @ **36de1a1** + second extract **593e18b** / PR #138 + docs tip-sync #139 @ **ce37e6a** + first extract **d04f5e9** / PR #136 + design **d90fbaf** / PR #135; GitHub default; `gleam build` clean. (See full table + remaining below.)**
...
- **Next product thinning:** GitHub `process_issue` thinning **complete** (design [`docs/design-github-process-issue-thinning.md`](design-github-process-issue-thinning.md); slices PR #112/#115/#117/#119/#121 → product tip **a3d9702**; `bin/grkr` 435 thin launcher; `github_issue.sh` 539). **Linear thinning complete** through final slice 5 @ **f6b34d4** / PR #133 (t_d9eb82bb): slices 1–4 extracts landed @ **7721b61**/#125 (test), **8ae5250**/#127 (publish), **ce34b29**/#129 (refusal), **48aa21b**/#131 (research/plan+implement_in_progress) + docs tip-sync #132 @ **3e7cbc5**; fifth/final thin `process_linear_issue` sequencer landed (bootstrap_linear_issue_task + run_linear_decision_stage + handle_linear_decision_refuse + run_linear_implement_stage; `linear_issue.sh` 386→329; stages 599→725) matching GitHub after a3d9702 / PR #121. **Shared helpers extract in progress** (design [`docs/design-grkr-shared-helpers-extract.md`](design-grkr-shared-helpers-extract.md) tip **d90fbaf** / PR #135): first slice (test-write) landed @ **d04f5e9** / PR #136 (t_d9c18700: `bin/grkr` 435→339; issue_shared 110) + docs tip-sync #137 @ **5e53aaf**. Slice 2 (line-limit + ensure_publishable_file_sizes) landed @ **593e18b** / PR #138 (t_9e60aed0: `bin/grkr` 339→279; issue_shared 110→178; functions now in issue_shared.sh; sourcing order unchanged) + docs tip-sync #139 @ **ce37e6a**. Slice 3 (run_codex_prompt) landed @ **325ee9a** / PR #140 (t_2091085e: `bin/grkr` 279→260; issue_shared 178→198; run_codex_prompt codex/exec + persist_task_log_output bridge now in issue_shared.sh; sourcing order unchanged) + docs tip-sync #141 @ **36de1a1**. Slice 4 (run_progress_cli + checkpoint_marker) landed @ **f6fb872** / PR #142 (t_bc6ebfda: `bin/grkr` 260→233; issue_shared 198→228; progress CLI bridge + marker fallback now in issue_shared.sh; sourcing order unchanged). Remaining per design after slice 4: attach_issue_logs, optional summarize_text hygiene. Files ≤1000 LOC. `GRKR_LINEAR_MUTATE=1` default OFF. Sourcing order (issue_shared before provider libs) preserved.
