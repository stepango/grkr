...
- Linear **workflow CLI body** (`grkr --linear-issue` research/plan/implement via progress linear mutations) — t_48db8096; Linear refusal + state mutations — t_2315506a. Supervisor Linear pick→schedule→spawn already landed (t_51747d23 @ ce61881; fixture e2e t_5254b489). GitHub remains default `GRKR_ISSUE_PROVIDER`.
