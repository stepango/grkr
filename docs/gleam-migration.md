...
**Current implementation status (2026-07-16, docs tip @ **729abd0** / PR #124 tip-sync after design **ad3e9a4** / PR #123 Linear `linear_issue.sh` thinning plan (t_8f47892b); product tip lineage @ **a3d9702** / PR #121 thin process_issue orchestrator (t_3619188b) after completion **def63d8** / PR #119 + research/plan **53592d4** / PR #117 + publish-helpers **6e0f1d3** / PR #115 + test-checkpoint **c438409** / PR #112; `bin/lib/github_issue.sh`, `bin/grkr` 875→...→527→435; Linear first extract slice t_9c0c6ab9: `ensure_linear_test_checkpoint` → `bin/lib/linear_issue_stages.sh` (`linear_issue.sh` 923→770); docs tip-sync #122 @ **bdf396b** after #121; docs tip-sync #120 @ **321aa11**; STRICT @ **82f3644** / PR #110; nits @ **8d4b674** / PR #107; land @ **e28d0c0** / PR #104; publish+complete @ bd523a6 / PR #100; FFI variables fix @ **36f8f03** / PR #106; docs tip-sync #111 @ **f07d578**; docs tip-sync #113 @ **219fde5**; docs tip-sync #116 @ **2ac57fb**; docs tip-sync #118 @ **bf530e5**): GitHub picker/refusal/supervisor on **main**; Linear research/plan + refuse + implement + test + publish+complete wired for `--linear-issue` (STAGE=complete; GitHub PR from linear-* + Done + comment); guarded live mutate (`GRKR_LINEAR_MUTATE=1` default-OFF, dumps+sidecars, stage-scoped keys, stricter parse, soft skipped-no-token; optional `GRKR_LINEAR_MUTATE_STRICT=1` hard-fails non-idempotent non-refuse applies, refuse stays soft) **landed** @ **e28d0c0** + nits **8d4b674** + STRICT **82f3644**; product thinning tip **a3d9702** (process_issue thin orchestrator); Linear shell thinning in progress (first slice extract landed this branch); GitHub default; `gleam build` clean. (See full table + remaining below.)**
