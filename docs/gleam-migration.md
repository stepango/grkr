...
**Current implementation status (2026-07-18, product tip @ **f6fb872** / PR #142 (shared fourth slice run_progress_cli + checkpoint_marker → issue_shared: grkr 260→233 / issue_shared 198→228; t_bc6ebfda); shared helpers fifth extract this PR (t_2847ff4d: attach_issue_logs → `bin/lib/issue_shared.sh`, `bin/grkr` 233→198 / issue_shared 228→249); lineage ... + docs tip-sync; GitHub default; `gleam build` clean. (See full table + remaining below.)**
