...
**Current implementation status (2026-07-17, product tip @ **d04f5e9** / PR #136 shared helpers first extract slice (t_d9c18700: test-write cluster → `bin/lib/issue_shared.sh`, `bin/grkr` 435→339 / issue_shared 110); lineage design **d90fbaf** / PR #135 + docs tip-sync #134 @ **5418159** after Linear fifth/final thin sequencer **f6b34d4** / PR #133 + docs tip-sync #132 @ **3e7cbc5** after fourth extract **48aa21b** / PR #131; third extract **ce34b29** / PR #129 + docs tip-sync #130 @ **b97fecc**; second extract **8ae5250** / PR #127 + docs tip-sync #128 @ **1ac9be2**; first extract **7721b61** / PR #125 + docs tip-sync #126 @ **57eef93**; docs tip lineage @ **729abd0** / PR #124 tip-sync after design **ad3e9a4** / PR #123 Linear `linear_issue.sh` thinning plan (t_8f47892b); GitHub process_issue product tip @ **a3d9702** / PR #121 thin process_issue orchestrator (t_3619188b) after completion **def63d8** / PR #119 + research/plan **53592d4** / PR #117 + publish-helpers **6e0f1d3** / PR #115 + test-checkpoint **c438409** / PR #112; `bin/lib/github_issue.sh`, `bin/grkr` 875→...→527→435→339; docs tip-sync #122 @ **bdf396b** after #121; docs tip-sync #120 @ **321aa11**; STRICT @ **82f3644** / PR #110; nits @ **8d4b674** / PR #107; land @ **e28d0c0** / PR #104; publish+complete @ bd523a6 / PR #100; FFI variables fix @ **36f8f03** / PR #106; docs tip-sync #111 @ **f07d578**; docs tip-sync #113 @ **219fde5**; docs tip-sync #116 @ **2ac57fb**; docs tip-sync #118 @ **bf530e5**): GitHub picker/refusal/supervisor on **main**; Linear research/plan + refuse + implement + test + publish+complete wired for `--linear-issue` (STAGE=complete; GitHub PR from linear-* + Done + comment); guarded live mutate (`GRKR_LINEAR_MUTATE=1` default-OFF, dumps+sidecars, stage-scoped keys, stricter parse, soft skipped-no-token; optional `GRKR_LINEAR_MUTATE_STRICT=1` hard-fails non-idempotent non-refuse applies, refuse stays soft) **landed** @ **e28d0c0** + nits **8d4b674** + STRICT **82f3644**; product tip lineage **d04f5e9** / PR #136 shared helpers first extract after docs tip-sync #134 @ **5418159** + Linear fifth/final thin sequencer **f6b34d4** / PR #133 + docs tip-sync #132 @ **3e7cbc5** after fourth extract **48aa21b** / PR #131; Linear shell thinning **complete** (slices 1–5 @ **f6b34d4**/#133: linear_issue.sh 386→329; stages 599→725); shared helpers extract **started** (slice 1 test-write @ **d04f5e9**/#136: grkr 435→339; issue_shared 110) (slice 1 test checkpoint @7721b61/PR#125 + slice 2 publish+complete @8ae5250/PR#127 + docs tip-sync #128 @1ac9be2 + slice 3 refusal checkpoint @ce34b29/PR#129 + docs tip-sync #130 @b97fecc + slice 4 research/plan + implement_in_progress @48aa21b/PR#131: linear_issue.sh 495→386 / stages 483→599 + docs tip-sync #132 @3e7cbc5 + slice 5 thin process_linear_issue sequencer @f6b34d4/PR#133: linear_issue.sh 386→329 / stages 599→725); GitHub default; `gleam build` clean. (See full table + remaining below.)**
