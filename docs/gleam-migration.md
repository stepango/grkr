...
**Current implementation status (2026-07-15, product tip @ **82f3644** / PR #110 optional `GRKR_LINEAR_MUTATE_STRICT=1`; nits @ **8d4b674** / PR #107; land @ **e28d0c0** / PR #104; publish+complete @ bd523a6 / PR #100; FFI variables fix @ **36f8f03** / PR #106): GitHub picker/refusal/supervisor on **main**; Linear research/plan + refuse + implement + test + publish+complete wired for `--linear-issue` (STAGE=complete; GitHub PR from linear-* + Done + comment); guarded live mutate (`GRKR_LINEAR_MUTATE=1` default-OFF, dumps+sidecars, stage-scoped keys, stricter parse, soft skipped-no-token; optional `GRKR_LINEAR_MUTATE_STRICT=1` hard-fails non-idempotent non-refuse applies, refuse stays soft) **landed** @ **e28d0c0** + nits **8d4b674** + STRICT **82f3644**; GitHub default; `gleam build` clean. (See full table + remaining below.)**
