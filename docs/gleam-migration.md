...
**Update t_7e55fd9b (next product after polish design):** Docs-only. New [`docs/design-next-product-after-coding-agent-polish.md`](design-next-product-after-coding-agent-polish.md): inventory + GO/NO-GO; slice 1 `coding_agent` concern split; slice 2 `doctor/validate`. Follow-up 4 DONE. No product code.
