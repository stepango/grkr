...
- **Next product thinning:** GitHub `process_issue` thinning **complete** (design [`docs/design-github-process-issue-thinning.md`](design-github-process-issue-thinning.md); slices PR #112/#115/#117/#119/#121 → product tip **a3d9702**; `bin/grkr` 435 thin launcher; `github_issue.sh` 539). **Next risk:** Linear `bin/lib/linear_issue.sh` ~923 LOC near AGENTS 1000 — see [`docs/design-linear-issue-thinning.md`](design-linear-issue-thinning.md) (ordered extract slices; first: extract `ensure_linear_test_checkpoint` to sibling stages lib). Prior GitHub lineage retained: Slice 1 (PR #112 @ c438409) test checkpoint; Slice 3 (PR #115 @ **6e0f1d3**) publish helpers; Slice 4 (PR #117 @ **53592d4**) research/plan; Slice 5 (PR #119 @ **def63d8**) completion; Slice 6 (PR #121 @ **a3d9702**) thin `process_issue` orchestrator. `linear_issue.sh` untouched through that lineage (empty diff, 923 LOC). Extract shared / Linear verticals before any Linear growth.
