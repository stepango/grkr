...
**Key Gleam modules implemented (all <1000 LOC, `gleam build` succeeds, `gleam test` 295 passed, 0 failures @ 78f4fb8 / lineage 62c73fb):**
...
- **supervisor/** (loop orchestration, recovery, locking, state + phases; per design in supervisor-design-final.md; phases split hygiene t_94976f9c (688→thin dispatcher + concern modules); loop updated):
  - main.gleam (56 LOC), phases.gleam (117 LOC thin dispatcher), phases_log.gleam (84), phases_sync (56), phases_pick (124), phases_reap (46), phases_cleanup (67), phases_scan_pr (104), phases_scan_comment (190) + **pick.gleam (152 LOC, t_73c1fbdf)**: `issue_provider_name()` reads `GRKR_ISSUE_PROVIDER` (default `github`; `linear` → `issue_provider/main`); `pick_next()` → provider-agnostic `SelectedWork`; `schedule_selected()` spawns GitHub `spawn_issue_execution` or Linear `spawn_linear_issue_execution` when ids present, loop.gleam (~274 LOC), recovery.gleam (~336 LOC: dead PID + `recover_stale_active_jobs` TTL/hung-lock per policy §6), worktree_cleanup.gleam (~172 LOC: classify + `collect_refusal_protected_tokens`), config.gleam (~171 LOC, `ACTIVE_JOB_TTL_SECONDS`), types.gleam (181 + active_job_ttl_seconds), state.gleam (263), lock.gleam (88), ffi.gleam (~134), scheduler.gleam (130)
...
- **progress/** (checkpoints/Linear + templates for thin wrappers; main split hygiene t_8c7cd0a0):
  - cli.gleam (206), main.gleam (63 thin facade), checkpoint_plan (144), linear_plan (222), templates_cli (121), linear_apply (188), checkpoint_render 103, linear_mutation 440, linear_state 112, checkpoint_id 74, checkpoint_stage 68, templates.gleam (238)
...
- **PR #79 MERGED** to `main` @ 78f4fb8 (2026-07-10); Linear JobKey @ **ce61881**; MVP tip **28e4794** (PR #93); refuse tip **8aba009** (PR #95); implement tip **d1c1240** (PR #97); test tip **bfee58c** (PR #98); publish tip **bd523a6** (PR #100); live-mutate land **e28d0c0** (PR #104); Linear variables FFI **36f8f03** (PR #106); live-mutate nits **8d4b674** (PR #107); optional STRICT **82f3644** (PR #110); docs tip-sync #111 @ **f07d578**; test-checkpoint thinning **c438409** (PR #112); docs tip-sync #113 @ **219fde5**; publish-helpers thinning **6e0f1d3** (PR #115); docs tip-sync #116 @ **2ac57fb**; research/plan thinning **53592d4** (PR #117); docs tip-sync #118 @ **bf530e5**; completion surface thinning **def63d8** (PR #119; grkr 545→527); docs tip-sync #120 @ **321aa11**; process_issue thin orchestrator product tip **a3d9702** (PR #121 / t_3619188b; `bin/grkr` 527→435; github_issue.sh 387→539); docs tip-sync #122 @ **bdf396b**; Linear thinning design tip **ad3e9a4** (PR #123 / t_8f47892b); docs tip-sync #124 @ **729abd0** after #123; Linear first extract product tip **7721b61** (PR #125 / t_9c0c6ab9; `linear_issue.sh` 923→770; stages 186); docs tip-sync #126 @ **57eef93** after #125; Linear second extract product tip **8ae5250** (PR #127 / t_8ca53b63; `linear_issue.sh` 770→613; stages 357); docs tip-sync #128 @ **1ac9be2** after #127; Linear third extract product tip **ce34b29** (PR #129 / t_7d3260b2; `linear_issue.sh` 613→495; stages 483); docs tip-sync #130 @ **b97fecc** after #129; Linear fourth extract product tip **48aa21b** (PR #131 / t_81b53e16; `linear_issue.sh` 495→386; stages 599); docs tip-sync #132 @ **3e7cbc5** after #131; Linear fifth/final thin sequencer product tip **f6b34d4** (PR #133 / t_d9eb82bb; `linear_issue.sh` 386→329; stages 725); docs tip-sync #134 @ **5418159** after #133; shared helpers design tip **d90fbaf** (PR #135 / t_7de2e4dd); shared helpers first extract product tip **d04f5e9** (PR #136 / t_d9c18700; `bin/grkr` 435→339; issue_shared 110); docs tip-sync #137 @ **5e53aaf** after #136; shared helpers second extract product tip **593e18b** (PR #138 / t_9e60aed0; `bin/grkr` 339→279; issue_shared 110→178); docs tip-sync #139 @ **ce37e6a** after #138; shared helpers third extract product tip **325ee9a** (PR #140 / t_2091085e; `bin/grkr` 279→260; issue_shared 178→198); docs tip-sync #141 @ **36de1a1** after #140; shared helpers fourth extract product tip **f6fb872** (PR #142 / t_bc6ebfda; `bin/grkr` 260→233; issue_shared 198→228); docs tip-sync #143 @ **3b0b2df** after #142; shared helpers fifth extract product tip **c801967** (PR #144 / t_2847ff4d; `bin/grkr` 233→198; issue_shared 228→249); docs tip-sync #145 @ **9a1b8f6** after #144; github_issue thinning design tip **15a5050** (PR #146 / t_0f32e023); github_issue PR body helpers product tip **1216e94** (PR #147 / t_e06571e3; github_issue.sh 545→543; templates 176→221); docs tip-sync #148 @ **745ca83** after #147; swappable coding agent product tip **d55dd73** (PR #149); coding-agent matrix + quality eval harness product tip **1edf636** (PR #150); docs tip-sync #151 @ **c918cde** after #150; github_issue completion summary polish product tip **29c7a4b** (PR #152 / t_dec62328; github_issue.sh 543→542; templates 221→238); docs tip-sync #153 @ **4613b02** after #152; supervisor phases LOC hygiene product tip **0d13a98** (PR #154 / t_94976f9c; phases.gleam 688→117 + 7 concern modules); docs tip-sync #155 @ **d02734b** after #154; progress/main LOC hygiene product tip **71075c2** (PR #156 / t_8c7cd0a0; main.gleam 644→63 + 4 concern modules); docs tip-sync #157 @ **a426932** after #156; handle_comment LOC hygiene product tip **e358311** (PR #158 / t_a12fcdec; handle_comment.gleam 456→92 + 6 concern modules); ongoing e2e cron regression + kanban hygiene (process — not missing spec/39 core modules)
- **Next product thinning:** GitHub `process_issue` thinning **complete** (design [`docs/design-github-process-issue-thinning.md`](design-github-process-issue-thinning.md); slices PR #112/#115/#117/#119/#121 → product tip **a3d9702**; `bin/grkr` 435 thin launcher; `github_issue.sh` 539). **Linear thinning complete** through final slice 5 @ **f6b34d4** / PR #133 (t_d9eb82bb): slices 1–4 extracts landed @ **7721b61**/#125 (test), **8ae5250**/#127 (publish), **ce34b29**/#129 (refusal), **48aa21b**/#131 (research/plan+implement_in_progress) + docs tip-sync #132 @ **3e7cbc5**; fifth/final thin `process_linear_issue` sequencer landed (bootstrap_linear_issue_task + run_linear_decision_stage + handle_linear_decision_refuse + run_linear_implement_stage; `linear_issue.sh` 386→329; stages 599→725) matching GitHub after a3d9702 / PR #121. **Shared helpers extract** (design [`docs/design-grkr-shared-helpers-extract.md`](design-grkr-shared-helpers-extract.md) tip **d90fbaf** / PR #135): first slice (test-write) landed @ **d04f5e9** / PR #136 (t_d9c18700: `bin/grkr` 435→339; issue_shared 110) + docs tip-sync #137 @ **5e53aaf**. Slice 2 (line-limit + ensure_publishable_file_sizes) landed @ **593e18b** / PR #138 (t_9e60aed0: `bin/grkr` 339→279; issue_shared 110→178) + docs tip-sync #139 @ **ce37e6a**. Slice 3 (run_codex_prompt) landed @ **325ee9a** / PR #140 (t_2091085e: `bin/grkr` 279→260; issue_shared 178→198) + docs tip-sync #141 @ **36de1a1**. Slice 4 (run_progress_cli + checkpoint_marker) landed @ **f6fb872** / PR #142 (t_bc6ebfda: `bin/grkr` 260→233; issue_shared 198→228) + docs tip-sync #143 @ **3b0b2df**. Slice 5 (attach_issue_logs) landed @ **c801967** / PR #144 (t_2847ff4d: verbatim move to `bin/lib/issue_shared.sh`, definition removed from `bin/grkr` with no wrapper, call sites ambient; hygiene: summarize_text deleted as confirmed dead with 0 callers); remaining: none for shared launcher helpers. **Landed after tip-sync #148:** swappable coding agent **d55dd73** / PR #149 + per-step coding-agent matrix + quality eval harness **1edf636** / PR #150 (`GRKR_CODING_AGENT` / `GRKR_AGENT_*`, issue_shared bridge, `scripts/coding-agent-eval-matrix.sh`; issue_shared ~249→387). **Next:** GitHub `github_issue.sh` thinning (design [`docs/design-github-issue-lib-thinning.md`](design-github-issue-lib-thinning.md) tip **15a5050** / PR #146): first slice PR body helpers landed @ **1216e94** / PR #147 (t_e06571e3); second slice completion summary polish landed @ **29c7a4b** / PR #152 (t_dec62328: render_github_completion_summary → Gleam + thin post_completion_comment; `github_issue.sh` 543→542; templates 221→238) + docs tip-sync #153 @ **4613b02**; supervisor phases LOC hygiene landed @ **0d13a98** / PR #154 (t_94976f9c: phases.gleam 688→117 thin dispatcher + 7 concern modules; zero behavior change) + docs tip-sync #155 @ **d02734b**; progress/main LOC hygiene landed @ **71075c2** / PR #156 (t_8c7cd0a0: main.gleam 644→63 thin facade + 4 concern modules checkpoint_plan/linear_plan/templates_cli/linear_apply; full public surface preserved; callers/tests unchanged; zero behavior change; all <<1000) + docs tip-sync #157 @ **a426932**; **handle_comment LOC hygiene landed** @ **e358311** / PR #158 (t_a12fcdec): 456 → thin facade 92 + 6 concern modules (types 23/context 129/reactions 48/worktree 88/codex 87/result 40); zero behavior change, CLI entry path stable. **resolve_pr/main LOC hygiene landed** (t_681d0503): 436 → thin facade 82 + workflow/apply/runtime; zero behavior change, `grkr/resolve_pr/main` entry + bin/worker-resolve-pr.sh contract stable. Remaining per design §5 table: checkpoint json helpers (optional/low-ROI). Next candidate: supervisor/comment_handler (~430). `bin/grkr` 198. Files ≤1000 LOC. `GRKR_LINEAR_MUTATE=1` default OFF. Sourcing order (issue_shared before provider libs) preserved. Live tip **e358311** / PR #158.

**Update t_bb4a09e6 (slice 3 publish extract):** Functional shell extraction (no behavior change). Moved `publish_issue_changes`, `extract_codex_pr_body`, `ensure_pr_body_limit` (GitHub-only PR body + Fixes footer + labels) from bin/grkr into bin/lib/github_issue.sh (after test checkpoint fns). Added `publish_github_issue_changes` alias. Removed old defs from grkr (sourcing of lib already present; call site unchanged). Updated lib header. grkr: 738→639 LOC; github_issue.sh ~263 LOC; linear diff empty. Per AGENTS: updated README.md + docs/gleam-migration.md; files <1000. Followed design §5 slice 3 + inventory + non-goals (ensure_publishable_file_sizes shared, left in grkr).

**Update t_b61f10e8 (slice 4 research/plan checkpoint extract):** Functional shell extraction (no behavior change). Moved `ensure_checkpoint_stage` (~research/plan reuse/restore/post via gh + progress) + gh-only comment helpers (`fetch_issue_comments_json`, `checkpoint_comment_id_from_json`, `checkpoint_comment_body_from_json`) from bin/grkr into bin/lib/github_issue.sh. `checkpoint_marker`, `write_research/plan_checkpoint_file`, `update_task_progress_stage` stay shared/ambient (call-time resolution). Call sites in process_issue unchanged (still `ensure_checkpoint_stage research ...` then plan). Added slice note to github_issue.sh header. grkr: 639→545 LOC; github_issue.sh ~360 LOC; linear diff empty. Per AGENTS: updated README.md + docs/gleam-migration.md; files <1000; ran all regression (smoke, checkpoint-resume, etc). Followed design §9 slice table + non-goals (no Linear, no process_issue body rewrite beyond removal, completion surface later).

**Update t_d328b158 (slice 5 completion extract):** Functional shell extraction (no behavior change). Moved `post_completion_comment` (~18 LOC; gh issue comment with ## Completion summary, Recommendation: ready, Branch/PR URLs) + alias `post_github_completion_comment` from bin/grkr into bin/lib/github_issue.sh (after publish helpers). Sourcing already present; call site in process_issue tail unchanged (still calls `post_completion_comment "$ISSUE" "$TITLE" "$BRANCH_URL" "$PR_URL"` after `mark_task_progress_complete` / `move_issue_to_done`). Updated lib header for Slice 5. grkr: 545→527 LOC; github_issue.sh 360→387 LOC; linear diff empty. Per AGENTS: updated README.md + docs/gleam-migration.md; files <1000; preserve shell convs (local, exact heredoc). Followed non-goals (no Linear, keep move_issue_to_done in grkr-project-status, mark in task_progress, no process_issue rewrite, no spec sync).

**Update t_3619188b (slice 6 thin process_issue orchestration):** Functional shell extraction (no behavior change, per design §9 last slice). Moved GitHub-specific stage bodies (bootstrap_github_issue_task for fetch+globals+meta+progress init; run_github_decision_stage for prepare+codex+gate+IMPLEMENTATION_DECISION; handle_github_decision_refuse; run_github_implement_stage for in-progress+implement+full impl-refusal conversion path + GITHUB_IMPL_REFUSED flag; finalize_github_issue_complete) exact bodies into bin/lib/github_issue.sh. Replaced thick process_issue (~134 LOC body) with thin orchestrator sequencing: bootstrap || ensure_checkpoint (research/plan) || run_decision || refuse-cleanup-or-proceed || run_implement (with flag early return) || ensure_publishable (shared stays) || ensure_test (lib) || publish (lib) || finalize. Used $TASK_DIR/implementation.log + CURRENT_PROMPT_FILE for downstream calls. Updated github_issue.sh header (slice 6). bin/grkr: 527→435 LOC (net reduction); github_issue.sh: 387→539 LOC; linear_issue.sh untouched (empty git diff, 923 LOC). All files ≤1000. Per AGENTS: updated README.md + docs/gleam-migration.md with LOC lineage (def63d8/527 → 435) + product tip note for card t_3619188b + "process_issue thin orchestrator". Followed design: exact moves, zero intentional behavior change, shared (ensure_publishable_file_sizes, run_codex_prompt, attach_issue_logs) kept in grkr; no Linear growth, no new flags, no spec edits. GitHub regressions (smoke + refusal + impl-to-refusal + checkpoints + limits) + gleam + npm required.

**Update (Linear test checkpoint extract, first slice per design-linear-issue-thinning §9):** Functional shell extraction (no behavior change). Moved exact body of `ensure_linear_test_checkpoint` from bin/lib/linear_issue.sh to new sibling `bin/lib/linear_issue_stages.sh`. Added BASH_SOURCE-relative source of stages lib in linear_issue.sh immediately after linear_mutate.sh source (ensures maybe_apply_linear_mutation ambient). Removed full function definition from linear_issue.sh (no thin wrapper left behind; ambient bash resolves). process_linear_issue call site args and logic unchanged. Header on stages.sh documents: Slice 1, ambient deps at call time (build_command_list, run_test_stage_hook, write_test_checkpoint_with_header, run_progress_cli, ..., maybe_apply, CURRENT_ISSUE_WORKTREE, LINEAR_STATE_TEST_ID, ...), and github_issue.sh vertical mirror pattern for Linear. linear_issue.sh: 923→770 LOC (net thinner); stages 186 LOC; both <<1000. Per AGENTS: updated README.md + docs/gleam-migration.md; Linear regressions (implement, refuse-progress, mvp, apply-matrix) + gleam build/test required. GitHub path + shared helpers untouched. Followed design §9 first slice + paste-ready brief + non-goals (no publish/refusal extract, no new flags, no mutate default change, no grkr change).

**Update (Linear publish+complete extract, second slice per design-linear-issue-thinning §8/§10):** Functional shell extraction (no behavior change; zero intentional delta for --linear-issue). Moved exact body of `ensure_linear_publish_complete` (~151 LOC + preceding comment block) from bin/lib/linear_issue.sh into existing sibling `bin/lib/linear_issue_stages.sh` (appended AFTER ensure_linear_test_checkpoint). Removed full function definition (no wrapper left in linear_issue.sh). Updated stages.sh header to document Slice 2 + full ambient deps for publish (ensure_publishable_file_sizes, stage_relevant_issue_files, git_in_issue_context, check_file_line_limit, generate_linear_implement_commit_message, extract_linear_codex_pr_body, mark_task_progress_complete, run_progress_cli, maybe_apply_linear_mutation; globals CURRENT_ISSUE_WORKTREE/REPO/MAIN_BRANCH/LINEAR_STATE_DONE_ID/BRANCH_URL/PR_URL). Updated source comment in linear_issue.sh to note Slice 2. Source order preserved (linear_mutate then stages). process_linear_issue call site + args unchanged. linear_issue.sh: 770→613 LOC (net thinner); stages: 186→357 LOC; both ≤1000. GitHub paths untouched (empty diff on github_issue.sh + grkr). Per AGENTS.md: after functional change, updated README.md + docs/gleam-migration.md thin notes (landed product tip **8ae5250** / PR #127; lineage docs tip-sync #126 @ **57eef93** after first extract **7721b61** / PR #125; LOC before/after). Followed exact body move, no new flags, no mutate default change, no GitHub behavior. Acceptance: all Linear regression tests (grkr-linear-issue-implement.sh full to complete, mvp, refuse, apply-matrix), gleam build/test, npm test.

**Update (Linear refusal checkpoint extract, third slice per design-linear-issue-thinning §8/§10):** Functional shell extraction (no behavior change; zero intentional delta for --linear-issue and direct callers). Moved exact body + preceding comment block of `ensure_linear_refusal_checkpoint` (~117 LOC, currently ~L260-377) from bin/lib/linear_issue.sh into existing sibling `bin/lib/linear_issue_stages.sh` (appended after publish+complete). Removed full function definition (no wrapper; ambient resolves via stages sourced from linear_issue.sh). Updated stages.sh header to document Slice 3 + refusal ambients: run_progress_cli (plan-linear-refusal, render-refusal, linear-comment-mutation, linear-state-mutation, linear-state), mark_task_progress_refused, maybe_apply_linear_mutation (from linear_mutate.sh, sourced first). Updated source comment in linear_issue.sh to note Slice 3. Source order and process_linear_issue call sites unchanged (still passes identifier, mutation_issue_id, task_slug, task_dir, progress, class, reasoning, optional state_id). Direct test caller (test/grkr-linear-refuse-progress.sh sources linear_issue.sh which sources stages) unchanged. linear_issue.sh: 613→495 LOC (net thinner, target ~500-ish); stages 357→483 LOC; both ≤1000. GitHub paths untouched (empty diff). Per AGENTS.md: after functional change, updated README.md + docs/gleam-migration.md thin notes (landed product tip **ce34b29** / PR #129; lineage docs tip-sync #128 @ **1ac9be2** after second extract **8ae5250** / PR #127; LOC before/after). Followed design: exact move, no new public flags, no live mutate default change (still soft, GRKR_LINEAR_MUTATE=1 for apply), no GitHub behavior, no spec edits. Acceptance verified: refusal test, implement, mvp, apply-matrix, gleam build + test, npm test.

**Update (Linear research/plan checkpoint + implement_in_progress extract, fourth slice per design-linear-issue-thinning §8/§10):** Functional shell extraction (no behavior change; zero intentional delta for --linear-issue). Moved exact bodies + preceding comments of `ensure_linear_checkpoint_stage` and `ensure_linear_implement_in_progress` from bin/lib/linear_issue.sh into `bin/lib/linear_issue_stages.sh` (appended after refusal). No wrappers left. Updated stages header (Slice 4 + ambients: write_research/plan_checkpoint_file, run_progress_cli for comment/state mutations, update_task_progress_stage, maybe_apply from linear_mutate.sh first). Updated linear_issue.sh source comment. Source order (mutate→stages) + process_linear_issue calls unchanged in meaning. linear_issue.sh 495→386 LOC; stages 483→599 LOC. Per AGENTS: README + gleam-migration updated (landed product tip **48aa21b** / PR #131; lineage docs tip-sync #130 @ **b97fecc** after third extract **ce34b29** / PR #129 + #125/#127); GitHub path untouched; all required tests green. Non-goals respected (no sequencer thin, no renames, no behavior change, no GitHub edits).

**Update (Linear thin process_linear_issue sequencer, final slice 5 per design-linear-issue-thinning §8 last row / §10):** Functional shell extraction (no behavior change; zero intentional delta on happy/refuse/impl-refusal/failure paths for --linear-issue). Added bootstrap_linear_issue_task (identifier/VALIDATION check + load + meta/context/progress seed) in linear_issue.sh (keeps load/meta helpers here per ownership). Extracted exact bodies of run_linear_decision_stage (prepare+provider+codex+gate+set IMPLEMENTATION_DECISION), handle_linear_decision_refuse, run_linear_implement_stage (ensure_in_progress + implement codex + detect_refusal conversion to ensure_linear_refusal_checkpoint + LINEAR_IMPL_REFUSED flag + cleanup) into linear_issue_stages.sh (append after Slice 4). Replaced fat process_linear_issue with thin sequencer exactly as sketched (matching GitHub post a3d9702): LINEAR_IMPL_REFUSED=0; bootstrap || ensure research/plan || run_decision || (if not proceed: handle return 0) || run_implement || (if refused return 0) || ensure test || ensure publish || finalize (clear CURRENT_*, rm prompt, STAGE=complete echoes). Used identical arg lists for ensure_* calls; codex_output path and CURRENT_PROMPT_FILE for publish. linear_issue.sh: 386→329 LOC (clearly under 500-600 preferred target); stages 599→725 LOC; both ≤1000. Updated headers in both (Slice 5, ambient deps list including prepare_worktree/run_codex/run_decision_gate/detect_*/ensure_*_refusal etc). Per AGENTS.md: after functional change, updated README.md + docs/gleam-migration.md with LOC lineage (before/after for this final Linear thinning; t_d9eb82bb); GitHub 100% untouched. Non-goals: no new flags, no mutate default, no Gleam sequencer, no GitHub edits. Acceptance: all Linear regression shells + gleam + npm. "Next product thinning" now marks Linear process_linear_issue thin sequencer complete (like GitHub a3d9702). Landed product tip **f6b34d4** / PR #133. Kanban: t_d9eb82bb.
...
**Update t_73c1fbdf (2026-06-22, landed t_56c8c193 @ d993152):** Added `src/grkr/supervisor/pick.gleam` + `test/grkr/supervisor/pick_test.gleam`; `phases.gleam` pick phase calls `pick.pick_next` / `pick.schedule_selected` instead of inlining github_picker only. Env `GRKR_ISSUE_PROVIDER` (`github` default, `linear` experimental) selects `github_picker/main` vs `issue_provider/main`. README fixture env vars documented. `gleam test` 289/289 on pushed v2 (PR #79).
...
**Update t_30fa61c7 (2026-06-23, GitHub pick+schedule parity audit):** Audited `github_picker` → `pick.pick_next` → `pick.schedule_selected` → `scheduler.spawn_issue_execution` → `state.record_active_job` + job/lock logs vs spec/parts/09-main-loop-contract.md, 11-state-model.md, 33-locking-and-concurrency.md. **Verified parity** on job keys (`issue:N:execution`), active_jobs JSON (`entity_type`, `entity_id`, `lock_name`, `task_slug`, `project_item_id`), flock wrapper + detached spawn. **Fixed:** shell log compat (`schedule_success_log_fields` / `schedule_pending_log_fields` in `pick.gleam`); `test/robot-main-schedules-issue.sh` now drives inline Gleam pick via `GITHUB_FIXTURE_PATH` (removed stale `worker-pick-issue.sh` mock); `bin/robot-main.sh` exports default `GRKR_ACTIVE_JOBS_PATH` + `GRKR_ISSUE_PROVIDER`. **Remaining gaps (documented at audit time):** Linear execution spawn still deferred (`schedule_selected` → `Ok(False)`); scheduler unit tests were only via `pick_test` + `robot-main-schedules-issue.sh` until t_09f442ca. `gleam test` **291/291** at audit; `gleam build` clean.

**Update t_09f442ca (2026-06-24, scheduler spawn unit tests):** Closed supervisor gap `no_scheduler_unit_test_module` from t_30fa61c7. Added `test/grkr/supervisor/scheduler_test.gleam` (4 tests) + `scheduler_fixture.mjs` for temp mock `grkr`, asserting GitHub `spawn_issue_execution` records `issue:N:execution` in active_jobs (entity_type/id, lock_name, task_slug, project_item_id), creates job log + per-issue flock lock file, invokes `grkr --issue N`, and falls back to `GRKR_ROOT/bin/grkr` when root `grkr` absent. `gleam test` **295/295**; `gleam build` clean. Linear execution spawn gap unchanged.

**Update t_5254b489 (2026-07-11, Linear supervisor schedule fixture e2e + doc sync):** Verified parent t_51747d23 @ **ce61881** already extended `test/robot-main-schedules-issue.sh` + `scheduler_test` for `GRKR_ISSUE_PROVIDER=linear` + `LINEAR_FIXTURE_PATH` → schedules `linear:ENG-123:execution` / `entity_type=issue_linear` / lock `eng-123` / mock `grkr --linear-issue ENG-123`. Re-ran green in isolated worktree (shared dir contested by t_48db8096 MVP): `gleam test` **298/298**, `npm test` **0**, schedule fixture **0**. Synced stale forward-looking bullets in README + docs/gleam-migration.md + optional `spec/parts/39` (GitHub default; remaining = Linear workflow CLI t_48db8096 + refusal t_2315506a). Ran `scripts/sync-spec.sh`.

**Update t_36708c41 (2026-07-12, post-merge tip sync after PR #92/#93):** Docs-only. Main tip promoted to **28e4794** (PR #93 `--linear-issue` research/plan MVP + multi-line KEY=val; parent PR #92 docs @ **5782431**). README + this header + forward-looking bullets now treat JobKey land **ce61881** as lineage, not tip. Remaining open: Linear refuse/state **t_503ca0f3** + **t_e47417cb**; implement/test/PR still deferred; GitHub default `GRKR_ISSUE_PROVIDER`. Included uncommitted AGENTS.md Grok Build CLI + owner PR merge policy sections. Ran `scripts/sync-spec.sh` after `spec/parts/39` touch. No product code.
...
**Update t_d1c43209 (2026-07-14, post-land tip sync after Linear live mutate PR #104):** Docs-only. Main tip promoted to **e28d0c0** (PR #104 guarded Linear live mutate apply, `GRKR_LINEAR_MUTATE=1` default OFF). README high-level snapshot + remaining-work + status line, this header + forward-looking bullets + lineage tip, and `spec/parts/39` note live mutate **landed** (gated; dry-run default); GitHub path untouched. Ran `scripts/sync-spec.sh` after `spec/parts/39` touch. No product code.

**Update t_14e53ce5 (2026-07-15, post-land tip sync after Linear live-mutate nits PR #107):** Docs-only. Main tip promoted to **8d4b674** (PR #107 stricter `mutation_result` parse, soft `skipped-no-token`, stage-scoped state keys only; lineage land **e28d0c0** / PR #104; FFI variables **36f8f03** / PR #106). README high-level snapshot + remaining-work + status line, this header + forward-looking bullets + lineage tip, and `spec/parts/39` tip refresh. Product parse/skip/keys bullets already in #107. Ran `scripts/sync-spec.sh` after `spec/parts/39` touch. No product code.

**Update t_8c077819 (2026-07-15, post-land tip sync after Linear MUTATE_STRICT PR #110):** Docs-only. Product tip promoted to **82f3644** (PR #110 optional `GRKR_LINEAR_MUTATE_STRICT=1` hard-fail for non-idempotent non-refuse Linear apply; refuse.* stays soft; lineage nits **8d4b674** / PR #107, land **e28d0c0** / PR #104, design #109 **68a50f0**). README high-level snapshot + remaining-work + status line, this header + forward-looking bullets + lineage tip, and `spec/parts/39` tip refresh. STRICT behavior already documented in product PR #110. Ran `scripts/sync-spec.sh` after `spec/parts/39` touch. No product code.

**Update t_575bec6c (2026-07-16, post-land tip sync after GitHub test checkpoint PR #112):** Docs-only. Product tip promoted to **c438409** (PR #112 extract GitHub test checkpoint to `bin/lib/github_issue.sh`; `bin/grkr` 875→738; first process_issue thinning slice per design #109 **68a50f0**). Lineage: docs tip-sync #111 **f07d578**, STRICT **82f3644** / PR #110, nits **8d4b674** / PR #107, land **e28d0c0** / PR #104. README high-level snapshot + remaining-work + status line, this header + forward-looking bullets + lineage tip, and `spec/parts/39` tip refresh. Product thinning bullet already in #112. Ran `scripts/sync-spec.sh` after `spec/parts/39` touch. No product code.

**Update t_b094ca64 (2026-07-16, post-land tip sync after GitHub publish helpers PR #115):** Docs-only. Product tip promoted to **6e0f1d3** (PR #115 extract GitHub publish helpers to `bin/lib/github_issue.sh`; `bin/grkr` 738→639; slice 3 process_issue thinning per design #109 **68a50f0** / t_bb4a09e6). Lineage: docs tip-sync #113 **219fde5**, test-checkpoint **c438409** / PR #112, STRICT **82f3644** / PR #110, nits **8d4b674** / PR #107, land **e28d0c0** / PR #104. README high-level snapshot + remaining-work + status line, this header + forward-looking bullets + lineage tip, and `spec/parts/39` tip refresh. Product thinning notes already in #115. Ran `scripts/sync-spec.sh` after `spec/parts/39` touch. No product code.

**Update t_8c7e956b (2026-07-16, post-land tip sync after GitHub research/plan checkpoint PR #117):** Docs-only. Product tip promoted to **53592d4** (PR #117 extract GitHub research/plan `ensure_checkpoint_stage` + gh comment helpers to `bin/lib/github_issue.sh`; `bin/grkr` 639→545; slice 4 process_issue thinning per design #109 **68a50f0** / t_b61f10e8). Lineage: docs tip-sync #116 **2ac57fb**, publish-helpers **6e0f1d3** / PR #115, test-checkpoint **c438409** / PR #112, STRICT **82f3644** / PR #110, nits **8d4b674** / PR #107, land **e28d0c0** / PR #104. README high-level snapshot + remaining-work + status line, this header + forward-looking bullets + lineage tip, and `spec/parts/39` tip refresh. Replaced product-PR "PR pending" wording with landed #117 @ **53592d4**. Ran `scripts/sync-spec.sh` after `spec/parts/39` touch. No product code.

**Update t_63a34b4d (2026-07-16, post-land tip sync after GitHub completion surface PR #119):** Docs-only. Product tip promoted to **def63d8** (PR #119 extract GitHub `post_completion_comment` + alias to `bin/lib/github_issue.sh`; `bin/grkr` 545→527; slice 5 process_issue thinning per design #109 **68a50f0** / t_d328b158). Lineage: docs tip-sync #118 **bf530e5**, research/plan **53592d4** / PR #117, publish-helpers **6e0f1d3** / PR #115, test-checkpoint **c438409** / PR #112, STRICT **82f3644** / PR #110, nits **8d4b674** / PR #107, land **e28d0c0** / PR #104. README high-level snapshot + remaining-work + status line, this header + forward-looking bullets + lineage tip, and `spec/parts/39` tip refresh. Replaced product-PR "this branch" wording with landed #119 @ **def63d8**. Ran `scripts/sync-spec.sh` after `spec/parts/39` touch. No product code.

**Update t_397fc315 (2026-07-16, post-land tip sync after GitHub process_issue thin orchestrator PR #121):** Docs-only. Product tip promoted to **a3d9702** (PR #121 thin `process_issue` to launcher + github_issue.sh delegates; `bin/grkr` 527→435; github_issue.sh 387→539; slice 6 process_issue thinning per design #109 **68a50f0** / t_3619188b). Lineage: docs tip-sync #120 **321aa11**, completion **def63d8** / PR #119, research/plan **53592d4** / PR #117, publish-helpers **6e0f1d3** / PR #115, test-checkpoint **c438409** / PR #112, STRICT **82f3644** / PR #110, nits **8d4b674** / PR #107, land **e28d0c0** / PR #104. README high-level snapshot + remaining-work + status line, this header + forward-looking bullets + lineage tip, and `spec/parts/39` tip refresh. Replaced product-PR "this worktree"/"this branch" wording with landed #121 @ **a3d9702**. Ran `scripts/sync-spec.sh` after `spec/parts/39` touch. No product code.

**Update t_efc845f9 (2026-07-16, post-land tip sync after Linear thinning design PR #123):** Docs-only. Docs tip promoted to **ad3e9a4** (PR #123 design Linear `linear_issue.sh` thinning plan t_8f47892b; `docs/design-linear-issue-thinning.md`; first slice extract `ensure_linear_test_checkpoint`). Product tip remains **a3d9702** / PR #121. Lineage: docs tip-sync #122 **bdf396b**, product **a3d9702** / PR #121, completion **def63d8** / PR #119, STRICT **82f3644** / PR #110, nits **8d4b674** / PR #107, land **e28d0c0** / PR #104. README high-level snapshot + remaining-work + status line, this header + forward-looking bullets + lineage tip, and `spec/parts/39` tip refresh. Ran `scripts/sync-spec.sh` after `spec/parts/39` touch. No product code.

**Update t_547b991a (2026-07-16, post-land tip sync after Linear test checkpoint extract PR #125):** Docs-only. Product tip promoted to **7721b61** (PR #125 extract `ensure_linear_test_checkpoint` to `bin/lib/linear_issue_stages.sh`; `linear_issue.sh` 923→770; stages 186; t_9c0c6ab9 first Linear thinning slice per design **ad3e9a4** / PR #123). Lineage: docs tip-sync #124 **729abd0**, design **ad3e9a4** / PR #123, product GitHub tip **a3d9702** / PR #121, docs tip-sync #122 **bdf396b**. README high-level snapshot + remaining-work + status line, this header + Next product thinning + lineage tip, and `spec/parts/39` tip refresh. Replaced product-PR "this branch" wording with landed #125 @ **7721b61**. Ran `scripts/sync-spec.sh` after `spec/parts/39` touch. No product code.

**Update t_429aa920 (2026-07-17, post-land tip sync after Linear publish+complete extract PR #127):** Docs-only. Product tip promoted to **8ae5250** (PR #127 extract `ensure_linear_publish_complete` to `bin/lib/linear_issue_stages.sh`; `linear_issue.sh` 770→613; stages 357; t_8ca53b63 second Linear thinning slice per design **ad3e9a4** / PR #123). Lineage: docs tip-sync #126 **57eef93**, first extract **7721b61** / PR #125, design **ad3e9a4** / PR #123, product GitHub tip **a3d9702** / PR #121. README high-level snapshot + remaining-work + status line, this header + Next product thinning + lineage tip, and `spec/parts/39` tip refresh. Replaced product-PR "this work" wording with landed #127 @ **8ae5250**. Ran `scripts/sync-spec.sh` after `spec/parts/39` touch. No product code.

**Update t_cbc73f64 (2026-07-17, post-land tip sync after Linear refusal checkpoint extract PR #129):** Docs-only. Product tip promoted to **ce34b29** (PR #129 extract `ensure_linear_refusal_checkpoint` to `bin/lib/linear_issue_stages.sh`; `linear_issue.sh` 613→495; stages 483; t_7d3260b2 third Linear thinning slice per design **ad3e9a4** / PR #123). Lineage: docs tip-sync #128 **1ac9be2**, second extract **8ae5250** / PR #127, first extract **7721b61** / PR #125, design **ad3e9a4** / PR #123, product GitHub tip **a3d9702** / PR #121. README high-level snapshot + remaining-work + status line, this header + Next product thinning + lineage tip, and `spec/parts/39` tip refresh. Replaced product-PR "this PR/this work" wording with landed #129 @ **ce34b29**. Ran `scripts/sync-spec.sh` after `spec/parts/39` touch. No product code.

**Update t_caf735d3 (2026-07-17, post-land tip sync after Linear research/plan+implement extract PR #131):** Docs-only. Product tip promoted to **48aa21b** (PR #131 extract `ensure_linear_checkpoint_stage` + `ensure_linear_implement_in_progress` to `bin/lib/linear_issue_stages.sh`; `linear_issue.sh` 495→386; stages 599; t_81b53e16 fourth Linear thinning slice per design **ad3e9a4** / PR #123). Lineage: docs tip-sync #130 **b97fecc**, third extract **ce34b29** / PR #129, second extract **8ae5250** / PR #127, first extract **7721b61** / PR #125, design **ad3e9a4** / PR #123, product GitHub tip **a3d9702** / PR #121. README high-level snapshot + remaining-work + status line, this header + Next product thinning + lineage tip, and `spec/parts/39` tip refresh. Replaced product-PR "this work"/branch wording with landed #131 @ **48aa21b**. Ran `scripts/sync-spec.sh` after `spec/parts/39` touch. No product code.

**Update t_a7663b6c (2026-07-17, post-land tip sync after Linear process_linear_issue thin sequencer PR #133):** Docs-only. Product tip promoted to **f6b34d4** (PR #133 thin `process_linear_issue` to pure sequencer — bootstrap + run_linear_decision_stage + handle_linear_decision_refuse + run_linear_implement_stage; `linear_issue.sh` 386→329; stages 725; t_d9eb82bb final Linear thinning slice per design **ad3e9a4** / PR #123). Lineage: docs tip-sync #132 **3e7cbc5**, fourth extract **48aa21b** / PR #131, third extract **ce34b29** / PR #129, second extract **8ae5250** / PR #127, first extract **7721b61** / PR #125, design **ad3e9a4** / PR #123, product GitHub tip **a3d9702** / PR #121. README high-level snapshot + remaining-work + status line, this header + Next product thinning + lineage tip, and `spec/parts/39` tip refresh. Replaced product-PR "this branch"/placeholder wording with landed #133 @ **f6b34d4**. Ran `scripts/sync-spec.sh` after `spec/parts/39` touch. No product code.

**Update t_4be9a7eb (2026-07-17, post-land tip sync after shared test-write issue_shared.sh PR #136):** Docs-only. Product tip promoted to **d04f5e9** (PR #136 extract shared test-write cluster `write_test_checkpoint_with_header` + `cleanup_test_result_logs` + `build_command_list` → `bin/lib/issue_shared.sh`; `bin/grkr` 435→339; issue_shared 110; t_d9c18700 first shared-helpers extract slice per design **d90fbaf** / PR #135). Lineage: design **d90fbaf** / PR #135, docs tip-sync #134 **5418159**, Linear fifth/final thin sequencer **f6b34d4** / PR #133, docs tip-sync #132 **3e7cbc5**, fourth extract **48aa21b** / PR #131, product GitHub tip **a3d9702** / PR #121. README high-level snapshot + remaining-work + status line + bin hygiene LOC, this header + Next product thinning + lineage tip, and `spec/parts/39` tip refresh. Replaced product-PR "this branch"/base-design-only wording with landed #136 @ **d04f5e9**. Ran `scripts/sync-spec.sh` after `spec/parts/39` touch. No product code.

**Update t_31c8031b (2026-07-17, post-land tip sync after shared helpers slice 2 line-limit+ensure_publishable PR #138):** Docs-only. Product tip promoted to **593e18b** (PR #138 extract `collect_file_line_limit_violations` + `check_file_line_limit` + `ensure_publishable_file_sizes` → `bin/lib/issue_shared.sh`; `bin/grkr` 339→279; issue_shared 110→178; t_9e60aed0 second shared-helpers extract slice per design **d90fbaf** / PR #135). Lineage: first extract **d04f5e9** / PR #136, docs tip-sync #137 **5e53aaf**, design **d90fbaf** / PR #135, Linear fifth/final thin sequencer **f6b34d4** / PR #133, product GitHub tip **a3d9702** / PR #121. README high-level snapshot + remaining-work + status line + bin hygiene LOC, this header + Next product thinning + lineage tip, and `spec/parts/39` tip refresh. Replaced product-PR placeholder wording with landed #138 @ **593e18b**. Ran `scripts/sync-spec.sh` after `spec/parts/39` touch. No product code.

**Update t_cc383d17 (2026-07-18, post-land tip sync after shared helpers slice 3 run_codex_prompt PR #140):** Docs-only. Product tip promoted to **325ee9a** (PR #140 extract `run_codex_prompt` → `bin/lib/issue_shared.sh`; `bin/grkr` 279→260; issue_shared 178→198; t_2091085e third shared-helpers extract slice per design **d90fbaf** / PR #135). Lineage: second extract **593e18b** / PR #138, docs tip-sync #139 **ce37e6a**, first extract **d04f5e9** / PR #136, design **d90fbaf** / PR #135, Linear fifth/final thin sequencer **f6b34d4** / PR #133, product GitHub tip **a3d9702** / PR #121. README high-level snapshot + remaining-work + status line + bin hygiene LOC, this header + Next product thinning + lineage tip, and `spec/parts/39` tip refresh. Replaced product-PR "this PR" wording with landed #140 @ **325ee9a**. Ran `scripts/sync-spec.sh` after `spec/parts/39` touch. No product code.

**Update t_9bdee305 (2026-07-18, post-land tip sync after shared helpers slice 4 run_progress_cli + checkpoint_marker PR #142):** Docs-only. Product tip promoted to **f6fb872** (PR #142 extract `run_progress_cli` + `checkpoint_marker` → `bin/lib/issue_shared.sh`; `bin/grkr` 260→233; issue_shared 198→228; t_bc6ebfda fourth shared-helpers extract slice per design **d90fbaf** / PR #135). Lineage: third extract **325ee9a** / PR #140, docs tip-sync #141 **36de1a1**, second extract **593e18b** / PR #138, docs tip-sync #139 **ce37e6a**, first extract **d04f5e9** / PR #136, design **d90fbaf** / PR #135, Linear fifth/final thin sequencer **f6b34d4** / PR #133, product GitHub tip **a3d9702** / PR #121. README high-level snapshot + remaining-work + status line + bin hygiene LOC, this header + Next product thinning + lineage tip, and `spec/parts/39` tip refresh. Replaced product-PR "this branch" wording with landed #142 @ **f6fb872**. Ran `scripts/sync-spec.sh` after `spec/parts/39` touch. No product code.

**Update t_2aef39e9 (2026-07-18, post-land tip sync after shared helpers slice 5 attach_issue_logs PR #144):** Docs-only. Product tip promoted to **c801967** (PR #144 extract `attach_issue_logs` → `bin/lib/issue_shared.sh`; `bin/grkr` 233→198; issue_shared 228→249; dead `summarize_text` removed; t_2847ff4d fifth shared-helpers extract slice per design **d90fbaf** / PR #135). Lineage: fourth extract **f6fb872** / PR #142, docs tip-sync #143 **3b0b2df**, third extract **325ee9a** / PR #140, docs tip-sync #141 **36de1a1**, second extract **593e18b** / PR #138, docs tip-sync #139 **ce37e6a**, first extract **d04f5e9** / PR #136, design **d90fbaf** / PR #135, Linear fifth/final thin sequencer **f6b34d4** / PR #133, product GitHub tip **a3d9702** / PR #121. README high-level snapshot + remaining-work + status line + bin hygiene LOC, this header + Next product thinning + lineage tip, and `spec/parts/39` tip refresh. Replaced product-PR "this PR" wording with landed #144 @ **c801967**. Ran `scripts/sync-spec.sh` after `spec/parts/39` touch. No product code.

**Update (GitHub github_issue.sh PR body helpers thinning, first slice per design-github-issue-lib-thinning §5/§9/§11):** Functional shell extraction (zero intentional behavior change; identical PR bodies with compact + exactly one Fixes #N, >60k handling via MAX_PR_BODY_CHARS, no new flags, GitHub default, Linear untouched, issue_shared frozen). Extended `src/grkr/progress/templates.gleam` (+~40 LOC) with pure `select_codex_heading_section` (matches awk ^## to end; empty if none) + `ensure_github_pr_body` (size check via string.length, swap to compact, append footer if missing). Wired `cli_select_codex_pr_section` + `cli_ensure_github_pr_body` in `main.gleam` + dispatch + path-based read (via cli_ffi) + help text in `cli.gleam`. Added thin `select_codex_pr_section` + `ensure_github_pr_body` delegates in `bin/grkr-templates.sh` (next to write/append PR renders). Replaced bodies of `ensure_pr_body_limit` + `extract_codex_pr_body` in `bin/lib/github_issue.sh` (545→543) with small sig-preserving delegates (use new thins + tmp for select on emitted sharded log; keep publish call site + sharded emit unchanged). Updated lib header for Slice 7. Added unit tests in `test/grkr/progress/main_test.gleam` (select cases, limit swap, footer dedup/no-dup, empty). Per AGENTS.md: after func change, updated README.md + docs/gleam-migration.md (Next + this Update); build/test/shells required. No spec edit. Landed product tip **1216e94** / PR #147 (t_e06571e3; design **15a5050** / PR #146; docs tip-sync #145 @ **9a1b8f6** after shared fifth **c801967** / PR #144; `github_issue.sh` 545→543; templates 176→221).

**Update t_1854917c (2026-07-19, post-land tip sync after GitHub PR body helpers thinning PR #147):** Docs-only. Product tip promoted to **1216e94** (PR #147 thin ensure_pr_body_limit + extract_codex_pr_body → Gleam progress/templates + cli + thin shell delegates; `github_issue.sh` 545→543; templates 176→221; t_e06571e3 first github_issue.sh→Gleam slice per design **15a5050** / PR #146). Lineage: design **15a5050** / PR #146, docs tip-sync #145 **9a1b8f6** after shared fifth **c801967** / PR #144, fourth extract **f6fb872** / PR #142, docs tip-sync #143 **3b0b2df**, Linear fifth/final thin sequencer **f6b34d4** / PR #133, product GitHub process_issue tip **a3d9702** / PR #121. README high-level snapshot + remaining-work + status line + bin hygiene LOC, this header + Next product thinning + lineage tip, and `spec/parts/39` tip refresh. Replaced product-PR placeholder wording with landed #147 @ **1216e94**. Ran `scripts/sync-spec.sh` after `spec/parts/39` touch. No product code.

**Update t_983c8bad (2026-07-19, post-land tip sync after coding-agent PRs #149/#150):** Docs-only. Product tip promoted to **1edf636** (PR #150 per-step coding-agent matrix + quality eval harness). Lineage: swappable coding agent **d55dd73** / PR #149, docs tip-sync #148 @ **745ca83** after github_issue PR body helpers **1216e94** / PR #147, design **15a5050** / PR #146, docs tip-sync #145 **9a1b8f6** after shared fifth **c801967** / PR #144. README high-level snapshot + remaining-work + status line + bin hygiene LOC, this header + Next product thinning + lineage tip, and `spec/parts/39` tip refresh. Preserved github_issue remaining rows (checkpoint json optional/low-ROI; phases hygiene done via t_94976f9c). Ran `scripts/sync-spec.sh` after `spec/parts/39` touch. No product code.

**Update (GitHub github_issue.sh completion summary polish per design §5/§10):** Functional (zero intent change; external contract identical). Pure `render_github_completion_summary` (templates) + cli wrapper (main) + dispatch (cli) + thin `render_github_completion_summary` (grkr-templates). `post_completion_comment` now thin (temp-file + gleam_tpl render + gh --body-file); signature/alias/finalize call unchanged. Exact string tests (main_test + empty URLs) + progress-cli extension. Smokes grepping "## Completion summary" green. github_issue 543→542 (net thinner), templates 221→238, main 635→644, cli 203→206. Non-goals followed (no Linear, no issue_shared, no checkpoint json). README + this doc updated. All required: gleam build/test, grkr-*-*.sh listed. Points remaining to checkpoint json (optional) + hygiene. Landed product tip **29c7a4b** / PR #152 (t_dec62328).

**Update t_a022dfbc (2026-07-19, post-land tip sync after github_issue completion polish PR #152):** Docs-only. Product tip promoted to **29c7a4b** (PR #152 GitHub completion summary render → Gleam + thin `post_completion_comment`; `github_issue.sh` 543→542; templates 221→238). Lineage: docs tip-sync #151 @ **c918cde** after coding-agent **1edf636** / PR #150 + **d55dd73** / PR #149 + github_issue PR body helpers **1216e94** / PR #147. README high-level snapshot + remaining-work + status line + bin hygiene LOC, this header + Next product thinning + lineage tip, and `spec/parts/39` tip refresh. Replaced product-PR "on wt/t_dec62328" wording with landed #152 @ **29c7a4b**. Remaining github_issue thinning: checkpoint json optional/low-ROI (phases hygiene landed t_94976f9c). Ran `scripts/sync-spec.sh` after `spec/parts/39` touch. No product code.

**Update (supervisor phases LOC hygiene split t_94976f9c per design-github-issue-lib-thinning §6):** Functional split (zero intentional behavior change). Split `src/grkr/supervisor/phases.gleam` (688 LOC) into thin dispatcher `phases.gleam` (117 LOC: run_all_phases + run_phase with fail injection + exact phase_started/completed logging + case dispatch) + concern modules under supervisor/: phases_log.gleam (shared escape/log_event/log_info/log_error for byte-identical logs), phases_sync.gleam, phases_pick.gleam (still delegates to pick.pick_next/schedule_selected), phases_reap.gleam, phases_cleanup.gleam, phases_scan_pr.gleam, phases_scan_comment.gleam (comment helpers stay here). Phase order, skip reasons (main_lock_busy, issues_lock_busy, prs_lock_busy, comments_lock_busy, no_matching_issue), lock paths, exit codes (75 etc), log strings, active_jobs, spawn contracts identical. All new files <<200 LOC; none >=700; total supervisor phases* well under limits. loop.gleam import unchanged (only run_all_phases). Per AGENTS: updated README + this doc (Next + supervisor bullet + this Update); gleam build 0w + 320 tests green; wc verified. Cites kanban t_94976f9c + design §6. No spec edits (no sync needed). Landed product tip **0d13a98** / PR #154 (t_94976f9c).

**Update t_8d9cf95e (2026-07-19, post-land tip sync after supervisor phases LOC hygiene PR #154):** Docs-only. Product tip promoted to **0d13a98** (PR #154 supervisor phases LOC hygiene: phases.gleam 688→117 thin dispatcher + phases_log/sync/pick/reap/cleanup/scan_pr/scan_comment; zero behavior change; t_94976f9c). Lineage: docs tip-sync #153 @ **4613b02** after github_issue completion polish **29c7a4b** / PR #152 + docs tip-sync #151 @ **c918cde** after coding-agent **1edf636** / PR #150. README high-level snapshot + remaining-work + status line, this header + Next product thinning + lineage tip, and `spec/parts/39` tip refresh. Replaced product-PR "on wt/t_94976f9c" wording with landed #154 @ **0d13a98**. Remaining github_issue thinning: checkpoint json optional/low-ROI. Ran `scripts/sync-spec.sh` after `spec/parts/39` touch. No product code.

**Update t_d36c87e9 (2026-07-19, post-land tip sync after progress/main LOC hygiene PR #156):** Docs-only. Product tip promoted to **71075c2** (PR #156 progress/main LOC hygiene: main.gleam 644→63 thin facade + checkpoint_plan 144 + linear_plan 222 + templates_cli 121 + linear_apply 188; zero behavior change; t_8c7cd0a0). Lineage: docs tip-sync #155 @ **d02734b** after supervisor phases LOC hygiene **0d13a98** / PR #154 (t_94976f9c) + docs tip-sync #153 @ **4613b02** after github_issue completion polish **29c7a4b** / PR #152. README high-level snapshot + remaining-work + status line, this header + Next product thinning + lineage tip, and `spec/parts/39` tip refresh. Replaced product-PR branch `refactor/progress-main-loc-split` wording with landed #156 @ **71075c2**. Remaining github_issue thinning: checkpoint json optional/low-ROI. Ran `scripts/sync-spec.sh` after `spec/parts/39` touch. No product code.

**Update t_1f60fc35 (2026-07-20, post-land tip sync after handle_comment LOC hygiene PR #158):** Docs-only. Product tip promoted to **e358311** (PR #158 handle_comment LOC hygiene: handle_comment.gleam 456→92 thin facade + types 23 + context 129 + reactions 48 + worktree 88 + codex 87 + result 40; zero behavior change; t_a12fcdec). Lineage: docs tip-sync #157 @ **a426932** after progress/main LOC hygiene **71075c2** / PR #156 (t_8c7cd0a0) + docs tip-sync #155 @ **d02734b** after supervisor phases LOC hygiene **0d13a98** / PR #154 (t_94976f9c). README high-level snapshot + remaining-work + status line, this header + Next product thinning + lineage tip, and `spec/parts/39` tip refresh. Replaced product-PR branch `refactor/handle-comment-loc-split` wording with landed #158 @ **e358311**. Remaining github_issue thinning: checkpoint json optional/low-ROI; next candidates supervisor/comment_handler ~430. Ran `scripts/sync-spec.sh` after `spec/parts/39` touch. No product code.

**Update t_a12fcdec (workflow/handle_comment LOC hygiene split):** Functional split (zero intentional behavior change). Split `src/grkr/workflow/handle_comment.gleam` (456 LOC) into thin public facade `handle_comment.gleam` (92 LOC: pub main + emit_usage + do_handle orchestration preserving exact eyes/worktree/codex/post/optional-push/rocket/cleanup sequence, exit codes, env defaults, logs, best-effort 0 on fetch fail) + concern modules under workflow/: handle_comment_types (23), _context (129: fetch + parses + run_gh), _reactions (48), _worktree (88: create per spec/12 + cleanup), _codex (87: prompt + CLASS/REPLY/CHANGES parse), _result (40). All new modules <<150; facade stable at grkr/workflow/handle_comment for bin/worker-handle-comment.sh (unchanged meaning), supervisor scan path, and tests. `gleam run -m grkr/workflow/handle_comment -- help` identical. Per AGENTS: README + docs/gleam-migration updated; "Next product thinning" marked landed with next candidate supervisor/comment_handler ~430; resolve_pr/main LOC hygiene landed in this slice; no spec/parts edits; no bin/worker-handle-comment.sh fattening; GitHub default untouched. Verified: gleam build 0 warnings, gleam test 320 passed, CLI entry, wc LOCs. Kanban t_a12fcdec. Landed product tip **e358311** / PR #158 (t_a12fcdec). Followed precedents (progress/main PR #156, phases PR #154).

**Update t_681d0503 (resolve_pr/main LOC hygiene split):** Functional split (zero intentional behavior change). Split `src/grkr/resolve_pr/main.gleam` (436 LOC) into thin public facade `main.gleam` (82 LOC: pub main + run_cli + emit_usage + run_cli_pr + fail_cli + pub run preserving exact argv patterns (help/[], [pr], ["--", pr]), GLEAM_ENV=test short-circuit, exit codes (usage→2, fail→1), log strings/order, error strings, worktree `.grkr/worktrees/pr-<n>/`, branch `robot/pr-<n>-conflict`, CONFLICT_STRATEGY default merge|rebase, push-fail-still-Ok on codex path) + concern modules: `workflow.gleam` (141: resolve_with_workflow/attempt/complete/cleanup + build_* + strategy helpers), `apply.gleam` (175: resolve_with_codex + finish_integration + validate_and_apply + get/write file content), `runtime.gleam` (108: ExecResult + execute_command + result_try + run_validation_commands + FFI wrappers). All new <<400; facade <<150; `grkr/resolve_pr/main` entry stable for bin/worker-resolve-pr.sh (exec unchanged). Per AGENTS: updated README + docs/gleam-migration.md (Next + this Update) with before/after (436→82); gleam build 0 warnings; gleam test 320 passed; CLI smokes (help exit 2, invalid exit 1, GLEAM_ENV=test exit 0); wc verified. No unrelated refactors (no codex/git/github/types public API changes; no Linear; GitHub default). Kanban t_681d0503. Followed precedents (handle_comment t_a12fcdec, progress/main t_8c7cd0a0, phases t_94976f9c).
...
**Update t_c3986548 (2026-07-02, hygiene: prune stale worktrees + lock audit + docs HEAD sync):** Pruned abandoned kanban worktrees `t_60ef75dc` (`wt/cron-fs-mjs-20260606` @ `7b95709`, unique `fs.mjs` null guard already on v2) and `t_abec58cb` (`wt/refusal-flow-cli-tests-20260606` @ `531762f`, ancestor of v2). Kept empty `.grkr/locks/main.lock` flock placeholder. Extended `.gitignore` for orchestrator body files, `.grkr/*.log`, `.grkr/tmp-*.sh`. Synced README / this file / `spec/parts/39` status HEAD from `18665c3` → **`6a34d26`** (still **295** `gleam test`). Local orphan `wt/*` branch names left (force-delete approval-gated; no worktrees attached).

**Update t_4e3d6c6a (2026-07-02, docs HEAD/test snapshot sync @ 454a65a):** Refreshed top status header + key-modules line + README high-level snapshot from stale `6a34d26` → live v2 tip **`454a65a`** (docs-only tip after green e2e t_3c34a581 / t_a90ebd70). Test snapshot from concurrent e2e: **`gleam test` 295/295**, npm exit 0, grkr-smoke 0. Code/migration status unchanged (GitHub picker/refusal/supervisor path complete; spec/39 items 6–12 done; Linear full spawn still deferred t_51747d23). Docs-only; no Linear path; no PR #79 merge.

**Update t_dacb3a58 (2026-07-05, hygiene lock/worktree audit @ d57f41a):** Re-audited worktrees and locks after `git worktree prune`: only the main `v2` worktree remains; repo `.worktrees/` is empty; `.grkr/locks/{comments,issues,main,prs}.lock` are empty flock placeholders with no `lsof` holders and were left untouched. Added `.gitignore` coverage for ephemeral `.grkr/kanban-cron-created-ids-*.txt`, refreshed README / this file from `454a65a` → **`d57f41a`** while retaining the **295/295** `gleam test` snapshot. Docs/hygiene-only; no spec/parts edits and no PR #79 merge.

**Update t_3839c543 (2026-07-05, hygiene re-audit after ad9342f):** Re-synced `v2` to `origin/v2` at **ad9342f**, ran `git worktree prune` (no prunable entries; only the main worktree remains), verified repo `.worktrees/` is empty, and left `.grkr/locks/{comments,issues,main,prs}.lock` as normal empty flock placeholders. Removed only empty unheld `~/.hermes/{auth.lock,kanban.db.dispatch.lock,kanban.db.init.lock}` after `lsof` showed no holders; kept live `~/.hermes/gateway.lock` and `~/.hermes/kanban/.dispatcher.lock` held by the gateway/dispatcher process. Docs-only sync to note the audit; spec sync skipped because `spec/parts/` was untouched.

**Update (shared test-write cluster extract, first slice per design-grkr-shared-helpers-extract.md):** Functional shell extraction (zero intentional behavior change). Created `bin/lib/issue_shared.sh` with exact bodies (including preceding multi-line comment) of `build_command_list`, `cleanup_test_result_logs`, and `write_test_checkpoint_with_header` moved verbatim from bin/grkr. Removed the three definitions from bin/grkr (no thin wrappers). Updated sourcing in bin/grkr: `. "$SCRIPT_DIR/lib/issue_shared.sh"` after `task_progress.sh` and before `linear_issue.sh` + `github_issue.sh` (creates sourcing precedent for neutral shared). Provider call sites unchanged (github_issue.sh `write_test_checkpoint_file` and linear_issue_stages.sh `ensure_linear_test_checkpoint` still resolve by name at call time). Small header polish in github_issue.sh noting test-write cluster now in issue_shared.sh. `bin/grkr` net thinner; new shared file well under 1000 LOC with headroom; all touched files ≤1000. Per AGENTS.md: updated README.md + docs/gleam-migration.md "Next product thinning" (first shared extract landed; remaining per design: line-limit/ensure_publishable, run_codex_prompt, progress bridge, attach_issue_logs). GitHub regressions (smoke, checkpoint-resume, line-limit, refusal, pr-body, impl-to-refusal) + Linear regressions (implement, mvp, refuse-progress, apply-matrix) + gleam build/test + npm test required. Landed product tip **d04f5e9** / PR #136 (t_d9c18700; base design tip **d90fbaf** / PR #135; `bin/grkr` 435→339; issue_shared 110). No new flags; GRKR_LINEAR_MUTATE default OFF; no process_issue move.

**Update (shared line-limit + ensure_publishable_file_sizes extract, slice 2 per design-grkr-shared-helpers-extract.md §5):** Functional shell extraction (zero intentional behavior change). Appended exact bodies of `collect_file_line_limit_violations`, `check_file_line_limit`, and `ensure_publishable_file_sizes` from bin/grkr to `bin/lib/issue_shared.sh`. Updated issue_shared.sh header to document Slice 1 + Slice 2 + ambient call-time deps (git_in_issue_context, stage_relevant_issue_files from grkr-issue-workflow, run_codex_prompt still in grkr, write_line_limit_fix_prompt in templates, MAX_FILE_LINES, CURRENT_ISSUE_WORKTREE). Removed the three defs from bin/grkr (no wrappers). Updated process_issue step-6 comment ("shared in issue_shared.sh"). Lightly updated github_issue.sh and linear_issue_stages.sh headers (docs only, noting line-limit helpers now in issue_shared). Call sites unchanged: process_issue, github publish, linear ensure_linear_publish_complete + check. `bin/grkr` 339→279 LOC; issue_shared 110→178 LOC. Per AGENTS.md: updated README.md high-level + "Next product thinning" (slice 2 landed; next remaining run_codex_prompt) + docs/gleam-migration.md (new Update section mirroring slice-1 style). All listed tests + gleam build/test + npm required. No spec/parts edits. No process_issue move, no run_codex etc extracted, no provider file growth, no new flags. Design refs: §3 inventory, §4 module map, §5 row "Line-limit + ensure...", §7 regression. Landed product tip **593e18b** / PR #138 (t_9e60aed0; prior first slice **d04f5e9** / PR #136; design **d90fbaf** / PR #135; `bin/grkr` 339→279; issue_shared 110→178).

**Update (shared run_codex_prompt extract, slice 3 per design-grkr-shared-helpers-extract.md §5):** Functional shell extraction (zero intentional behavior change; identical external contracts for --issue and --linear-issue). Moved the exact body of `run_codex_prompt` (codex exec + persist_task_log_output bridge) VERBATIM from bin/grkr into `bin/lib/issue_shared.sh` (appended after ensure_publishable_file_sizes). Removed the definition entirely from bin/grkr (no thin wrapper). Call sites unchanged (github_issue.sh decision/implement stages, linear_issue_stages.sh decision/implement stages, and ensure_publishable_file_sizes remediation path inside issue_shared itself). Sourcing order preserved exactly (issue_shared before linear_issue.sh + github_issue.sh). Updated issue_shared.sh header (Slice 3 + ambient: persist_task_log_output from grkr-issue-workflow.sh). Light docs-only header updates in github_issue.sh and linear_issue_stages.sh (run_codex_prompt now in issue_shared). `bin/grkr` 279→260 LOC (net thinner); issue_shared 178→198 LOC; all files <<1000. Per AGENTS.md: after functional change, updated README.md (bin hygiene + status) + docs/gleam-migration.md (new Update section + Next product thinning note describing lineage from 593e18b / ce37e6a; remaining after: run_progress_cli + checkpoint_marker, attach_issue_logs, optional summarize_text). No spec/parts edits. Design refs: §5 ordered table row for run_codex_prompt, §7 regression surface. Landed product tip **325ee9a** / PR #140 (t_2091085e; prior second slice **593e18b** / PR #138 + docs tip-sync #139 @ **ce37e6a**; first slice **d04f5e9** / PR #136; design **d90fbaf** / PR #135; `bin/grkr` 279→260; issue_shared 178→198). GitHub default + GRKR_LINEAR_MUTATE default OFF unchanged. All regression shells + gleam build/test + npm required.

**Update (shared run_progress_cli + checkpoint_marker extract, slice 4 per design-grkr-shared-helpers-extract.md §5):** Functional shell extraction (zero intentional behavior change; progress-cli + Linear mutation planning + GitHub checkpoint markers identical). Moved the exact bodies of `run_progress_cli` + `checkpoint_marker` VERBATIM from bin/grkr into `bin/lib/issue_shared.sh` (appended after run_codex_prompt). Removed both definitions entirely from bin/grkr (no thin wrappers left). Call sites unchanged (github_issue.sh markers, linear_issue_stages.sh + linear_mutate.sh via run_progress_cli for all planning/mutations/markers, write_test_checkpoint_with_header inside issue_shared, tests). Sourcing order preserved exactly (issue_shared before linear_issue.sh + github_issue.sh). Updated issue_shared.sh header (Slice 4 + accurate ambient note: SCRIPT_DIR / GRKR_GLEAM_PROJECT_ROOT resolved at call time from grkr; fallback marker when no gleam.toml identical). Light docs-only header update in github_issue.sh (progress bridge now in issue_shared). `bin/grkr` 260→233 LOC (net ~27 lines thinner); issue_shared 198→228 LOC; all files <<1000 with headroom. Per AGENTS.md: after functional change, updated README.md + docs/gleam-migration.md (new Update section + Next product thinning note with LOC lineage; remaining after slice 4: attach_issue_logs, optional summarize_text hygiene). No spec/parts edits (product extract). Design refs: §5 ordered table row "run_progress_cli + checkpoint_marker". Landed product tip **f6fb872** / PR #142 (t_bc6ebfda; prior slice 3 **325ee9a** / PR #140 + docs tip-sync #141 @ **36de1a1**; design **d90fbaf** / PR #135; `bin/grkr` 260→233; issue_shared 198→228). GitHub default + GRKR_LINEAR_MUTATE=1 default OFF; zero new flags; no behavior change. All listed verification + gleam build/test + npm test + targeted checkpoint/resume/Linear regression shells required.

**Update (shared attach_issue_logs extract, slice 5 per design-grkr-shared-helpers-extract.md §5):** Functional shell extraction (zero intentional behavior change; GitHub finalize + refusal paths attach identical logs; Linear untouched with empty diff). Appended exact body of `attach_issue_logs` VERBATIM from bin/grkr into `bin/lib/issue_shared.sh` (after checkpoint_marker). Removed the definition entirely from bin/grkr (NO wrapper left). Call sites ambient (cleanup_on_exit in grkr; finalize + refuse paths in github_issue.sh; refusal in refusal_paths.sh) unchanged by name. Sourcing order preserved. Updated issue_shared.sh header (Slice 5 + CURRENT_ISSUE + LOGFILE ambient + gh note documented). Updated github_issue.sh header note (attach now in issue_shared; remaining launcher-only: optional dead summarize_text / process_issue). Hygiene: deleted summarize_text (rg --glob '*.sh' confirmed only def, 0 callers). `bin/grkr` 233→198 LOC (net thinner ~35); issue_shared 228→249 LOC; all ≤1000. Per AGENTS: updated README + gleam-migration (Next: slice 5 landed; remaining none); Linear empty product diff verified. No spec/parts. Design refs: §3, §5 attach row. Landed product tip **c801967** / PR #144 (t_2847ff4d; prior **f6fb872** / PR #142 + docs tip-sync #143 @ **3b0b2df**; design **d90fbaf** / PR #135; `bin/grkr` 233→198; issue_shared 228→249). GitHub default, GRKR_LINEAR_MUTATE default OFF; zero behavior change. All verifications + regressions + gleam + npm required.
