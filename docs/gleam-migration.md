...
**Current implementation status (2026-07-18, this PR shared third slice run_codex_prompt → issue_shared: grkr 279→260 / issue_shared 178→198; t_2091085e); lineage product tip **593e18b** / PR #138 + docs tip-sync #139 @ **ce37e6a** + first extract **d04f5e9** / PR #136 + design **d90fbaf** / PR #135; GitHub default; `gleam build` clean. (See full table + remaining below.)**
