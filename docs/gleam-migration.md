...
- **PR #79 MERGED** to `main` @ 78f4fb8 (2026-07-10); Linear JobKey @ **ce61881**; MVP tip **28e4794** (PR #93); refuse tip **8aba009** (PR #95); implement tip **d1c1240** (PR #97); test tip **bfee58c** (PR #98); publish tip **bd523a6** (PR #100); live-mutate land **e28d0c0** (PR #104); Linear variables FFI **36f8f03** (PR #106); live-mutate nits **8d4b674** (PR #107); optional STRICT **82f3644** (PR #110); docs tip-sync #111 @ **f07d578**; test-checkpoint thinning **c438409** (PR #112); docs tip-sync #113 @ **219fde5**; publish-helpers thinning **6e0f1d3** (PR #115); docs tip-sync #116 @ **2ac57fb**; research/plan thinning **53592d4** (PR #117); docs tip-sync #118 @ **bf530e5**; completion surface thinning **def63d8** (PR #119; grkr 545→527); docs tip-sync #120 @ **321aa11**; process_issue thin orchestrator product tip **a3d9702** (PR #121 / t_3619188b; `bin/grkr` 527→435; github_issue.sh 387→539); docs tip-sync #122 @ **bdf396b**; Linear thinning design tip **ad3e9a4** (PR #123 / t_8f47892b); ongoing e2e cron regression + kanban hygiene (process — not missing spec/39 core modules)
- **Next product thinning:** GitHub `process_issue` thinning **complete** (design [`docs/design-github-process-issue-thinning.md`](design-github-process-issue-thinning.md); slices PR #112/#115/#117/#119/#121 → product tip **a3d9702**; `bin/grkr` 435 thin launcher; `github_issue.sh` 539). **Next risk:** Linear `bin/lib/linear_issue.sh` ~923 LOC near AGENTS 1000 — design tip **ad3e9a4** / PR #123 [`docs/design-linear-issue-thinning.md`](design-linear-issue-thinning.md) (ordered extract slices; first: extract `ensure_linear_test_checkpoint` to sibling stages lib). Prior GitHub lineage retained: Slice 1 (PR #112 @ c438409) test checkpoint; Slice 3 (PR #115 @ **6e0f1d3**) publish helpers; Slice 4 (PR #117 @ **53592d4**) research/plan; Slice 5 (PR #119 @ **def63d8**) completion; Slice 6 (PR #121 @ **a3d9702**) thin `process_issue` orchestrator. `linear_issue.sh` untouched through that lineage (empty diff, 923 LOC). Extract shared / Linear verticals before any Linear growth.
