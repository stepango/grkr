...
**Current implementation status (2026-07-16, product tip lineage @ **def63d8** / PR #119 completion surface extract (t_d328b158) after research/plan **53592d4** / PR #117 + publish-helpers **6e0f1d3** / PR #115 + test-checkpoint **c438409** / PR #112 → `bin/lib/github_issue.sh`, `bin/grkr` 875→738→639→545→527; STRICT @ **82f3644** / PR #110; nits @ **8d4b674** / PR #107; land @ **e28d0c0** / PR #104; publish+complete @ bd523a6 / PR #100; FFI variables fix @ **36f8f03** / PR #106; docs tip-sync #111 @ **f07d578**; docs tip-sync #113 @ **219fde5**; docs tip-sync #116 @ **2ac57fb**; docs tip-sync #118 @ **bf530e5**): GitHub picker/refusal/supervisor on **main**; Linear research/plan + refuse + implement + test + publish+complete wired for `--linear-issue` (STAGE=complete; GitHub PR from linear-* + Done + comment); guarded live mutate (`GRKR_LINEAR_MUTATE=1` default-OFF, dumps+sidecars, stage-scoped keys, stricter parse, soft skipped-no-token; optional `GRKR_LINEAR_MUTATE_STRICT=1` hard-fails non-idempotent non-refuse applies, refuse stays soft) **landed** @ **e28d0c0** + nits **8d4b674** + STRICT **82f3644**; thinning tip **def63d8** (completion + prior research/plan/publish/checkpoint); GitHub default; `gleam build` clean. (See full table + remaining below.)**
