...
Status snapshot (Gleam v2 main tip **`bd523a6`** post PR #100 Linear publish+complete dry-run; GitHub-default refusal-aware pipeline; historical counts e.g. **298** pre-MVP / **300** on Linear MVP tip / **304** on refuse tip / **305** on test-stage tip):
