//// comment_handler_context.gleam
//// GH context fetch, JSON parsing, run_gh for supervisor/comment_handler (LOC hygiene split).
//// Moved verbatim from monolithic comment_handler.gleam (zero behavior change).
/// Keep "comment_handler" identity; logs remain in facade/orchestration.
...
import grkr/supervisor/comment_handler_types.{type CommentContext, CommentContext}
