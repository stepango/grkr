//// comment_handler_reactions.gleam
//// Eyes + rocket reaction helpers for supervisor/comment_handler (LOC hygiene).
//// Moved verbatim; best-effort semantics unchanged.
/// Keep "comment_handler" identity (logs and facade unchanged).
